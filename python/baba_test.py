...
init_constant(dataset='ensemble', booster='gbtree', version=1, random_state=0)
...
if __name__ == '__main__':
    if BOOSTER == 'gblinear':
        ...
        train_score, valid_score = tune_gblinear(dtrain, dvalid, 0.001, 10, True,
        ...
        train_size = 59716
        valid_size = 14929
        train_labels, valid_labels = get_labels(train_size, valid_size)
        model_preds = get_model_preds(model_name_list)
        ...
        train_score, valid_score = average_predict(model_preds, train_size=train_size, valid_size=valid_size,
